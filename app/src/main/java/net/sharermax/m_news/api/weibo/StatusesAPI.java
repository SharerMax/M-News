...
package net.sharermax.m_news.api.weibo;
...
public class StatusesAPI extends AbsOpenAPI {
    ...
    /**
     * @see #friendsTimeline(long, long, int, int, boolean, int, boolean, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #mentions(long, long, int, int, int, int, int, boolean, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #update(String, String, String, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #upload(String, android.graphics.Bitmap, String, String, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #uploadUrlText(String, String, String, String, String, com.sina.weibo.sdk.net.RequestListener)
     */
