 ...
 * alternative is via the {@link net.sharermax.m_news.view.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
	 ...
	 * {@link #setCustomTabColorizer(net.sharermax.m_news.view.SlidingTabLayout.TabColorizer)}.
	 */
	...
	/**
	 * Set the custom {@link net.sharermax.m_news.view.SlidingTabLayout.TabColorizer} to be used.
	 *
	...
	/**
	 * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link net.sharermax.m_news.view.SlidingTabLayout} you are
